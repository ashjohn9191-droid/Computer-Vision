...
face_cascade = cv2.CascadeClassifier(r"C:\Users\ANITHA\Desktop\IMAGENET\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier(r"C:\Users\ANITHA\Desktop\IMAGENET\haarcascade_eye.xml")
...
def detect_faces_and_eyes(gray, frame):
    ...
    # If faces are detected, process each face individually
...
video_capture = cv2.VideoCapture(r"C:\Users\ANITHA\Downloads\3248998-uhd_3840_2160_25fps.mp4")
...
print("Video file opened successfully. Starting face and eye detection...")
